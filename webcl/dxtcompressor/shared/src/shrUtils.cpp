...
char* shrFindFilePath(const char* filename, const char* executable_path) 
{
    ...
    const char* searchPath[] = {
        ...
        "../../../samples_nvidia/<executable_name>/",          // up 3 in tree, then "/samples_nvidia/<exe name>/" 
        "../../../samples_nvidia/<executable_name>/data/",     // up 3 in tree, then "/samples_nvidia/data/" 
        "../../../samples_nvidia/<executable_name>/src/",      // up 3 in tree, then "/samples_nvidia/src/" 
        "../../../samples_nvidia/<executable_name>/inc/",      // up 3 in tree, then "/samples_nvidia/inc/" 
