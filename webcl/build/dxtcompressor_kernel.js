...
Module['FS_createPath']('/', 'data', true, true);
    ...
    var PACKAGE_UUID = '1dcf2ecb-0ec6-4739-a954-b6d92647cfb5';
    ...
    function processPackageData(arrayBuffer) {
      ...
      var curr;
        ...
        curr.onload();
                Module['removeRunDependency']('datafile_../build/dxtcompressor_kernel.data');

    };
    Module['addRunDependency']('datafile_../build/dxtcompressor_kernel.data');
