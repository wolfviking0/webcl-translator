...
function copyTempDouble(ptr) {
  ...
  var GL={counter:1,buffers:[],programs:[],framebuffers:[],renderbuffers:[],textures:[],uniforms:[],shaders:[],currArrayBuffer:0,currElementArrayBuffer:0,byteSizeByTypeRoot:5120,byteSizeByType:[1,1,2,2,4,4,4,2,3,4,8],uniformTable:{},packAlignment:4,unpackAlignment:4,init:function () {
      ...
      }};var CL={};function _clGetDeviceIDs(platform,device_type_i64_1,device_type_i64_2,num_entries,devices,num_devices) {
  ...
  function _clCreateCommandQueue(context,device,properties,cl_errcode_ret) {
  ...
  function _webclPrintStackTrace() {
  Module['printErr']('missing function: webclPrintStackTrace'); abort(-1);
  }
