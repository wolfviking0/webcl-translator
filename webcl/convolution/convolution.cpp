...
int main(int argc, char** argv)
{
	...
	std::ifstream srcFile("convolution_kernel.cl");
...
#ifdef __EMSCRIPTEN__
  // \todo
  // It's necessary to call clCreateCommandQueue first
  // if we use clCreateBuffer with CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR
